...
const VERSION = 'v19';     // v18：教务端补「限时征集」入口(super/admin/both 漏列的 gather 进 NAV_ORDER)+ 学生端打卡+请假合到一页 + 每日新闻升底部 tab(stuNews tab=3);v17：更新机制改写——新 SW 接管后通过 controllerchange 自动 reload（不再依赖开屏期）

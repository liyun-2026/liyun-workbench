#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""03×06 结合方向的 4 张变体：裁水印 + 2x2 总览（含真机小尺寸条）。"""
import os
...
SRC = [
    ('A 深炭·浪',   'Flat_mobile_app_icon__square_1_2026-09-20T13-47-58.png'),
    ('B 暖白·浪',   'Flat_mobile_app_icon__square_1_2026-09-20T13-48-12.png'),
    ('C 青·共鸣弧', 'Flat_mobile_app_icon__square_1_2026-09-20T13-48-28.png'),
    ('D 深炭·浪+点', 'Flat_mobile_app_icon__square_1_2026-09-20T13-48-45.png'),
]
...
for tag, fn in SRC:
    im = clean(fn)
    im.save(os.path.join(OUT, f'图标_v2_{tag}.png'))
    cells.append((tag, im))

PAD, GAP, CW, IMG_H, LBL_H = 46, 24, 380, 320, 40
CELL_H = IMG_H + LBL_H
TITLE_H = 96
STRIP_H = 150
COLS, ROWS = 2, 2
...
d = ImageDraw.Draw(cv)
d.text((PAD, 26), '砺蕴 · 03×06 结合 · 平面徽章（4 变体）', font=font(32), fill=(34, 30, 26))
d.text((PAD, 66), '金环里放金浪，全部平面、无渐变无立体。下排＝真机 120px 圆角方 / 56px',
...
cv.save(os.path.join(OUT, '图标_v2_总览.png'))
print('ok -> 预览/图标_v2_总览.png')
